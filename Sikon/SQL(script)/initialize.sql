...
VALUES (seq_couponhodler_issue_no.NEXTVAL, 10000, 'asdf@naver.com', '2022/05/12', '2022/06/30', '사용가능');
...
INSERT
INTO purchase( tran_no , prod_no, user_id, receiver_name, receiver_phone, receiver_email, quantity, divy_addr, divy_message, used_coupon, used_point, earn_point, orderdate, payment_opt, divy_status, invoice_num, divy_fee) 
VALUES (seq_purchase_tran_no.NEXTVAL , 10000, 'asdf@naver.com', '힙쟁이', '01012345678', 'heap@naver.com', 5, '비트캠프', '8층으로 가져다주세요', '10% 할인쿠폰', 500, 270, SYSDATE, 'KA', '001', '송장번호', 3000);

INSERT
INTO cart( cart_no , prod_no, user_id, quantity) 
VALUES (seq_cart_cart_no.NEXTVAL , 10000, 'asdf@naver.com', 5);
...
VALUES (seq_apply_apply_no.nextval, '10000', 'asdf@naver.com', '카카오페이', '100', 10, '2022/06/30' );

INSERT
INTO heart(heart_no , cook_no , user_id) 
VALUES(seq_heart_heart_no.nextval, '10000'  , 'asdf@naver.com');

INSERT
INTO wish( wish_no , cook_no, user_id, cook_status, cook_name ,cook_filename ,cook_price )
VALUES (seq_wish_wish_no.NEXTVAL , 10000, 'asdf@naver.com', 5, '예다의 계란 후라이 쿠킹클래스', 'yyy.jpg', 14000);
...
INSERT
INTO bookmark
VALUES	 (seq_bookmark_no.nextval ,'10000' , 'asdf@naver.com');
