...
출처: https://pjsprogram.tistory.com/13 [행배]
	...
	<div class="container">
		...
		<input type="hidden" id="tranNo" name="tranNo" value="${purchase.tranNo}"/>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="receiverName" name="receiverName" value="${purchase.receiverName}" placeholder="YYYY-MM-DD">
		    </div>
		  </div>
